    ...
    <div className="relative overflow-hidden">
      <div className="relative px-6 py-20">
        ...
        <article className="mx-auto max-w-3xl">
          ...
          <div className="mb-12 aspect-video overflow-hidden rounded-lg border border-slate-800 bg-gradient-to-br from-cyan-500/20 to-blue-600/20">
              ...
              <div className="space-y-6 text-slate-300">
                {post.content.split('\n\n').map((paragraph, idx) => {
                  if (paragraph.startsWith('# ')) {
                    return (
                      <h1 key={idx} className="text-3xl font-bold text-white">
                        {paragraph.replace('# ', '')}
                      </h1>
                    );
          ...
          <div className="mt-12 flex items-center justify-between border-t border-slate-800 pt-8">
            <div>
              <p className="text-sm font-medium text-slate-400">Share this article</p>
            </div>
            <div className="flex gap-3">
              <button className="flex h-10 w-10 items-center justify-center rounded-full border border-slate-700 text-slate-400 transition hover:bg-slate-800 hover:text-white">
