# CLAUDE.md - BlackRoad OS Web Portal

This document provides comprehensive guidance for AI assistants working on the BlackRoad OS Web Portal codebase.

## Project Overview

**BlackRoad OS Web Portal** is a static-first Next.js 14 public web portal that serves as the documentation and health surface for the BlackRoad OS ecosystem. It's designed for composable agent orchestration with observability-ready primitives.

- **Repository**: blackroad-os-web
- **Version**: 0.1.0
- **Description**: Public-facing surface for orchestrating intelligent systems
...
- **SITE_URL**: Base URL for metadata (default: `https://blackroad.os`)
...
**For**: BlackRoad OS Web Portal Development
